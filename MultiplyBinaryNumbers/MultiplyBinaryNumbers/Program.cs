...
namespace MultiplyBinaryNumbers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string product = Convert.ToString(firstBinary * secondBinary, 2);
            Console.WriteLine("Product of the two numbers in binary is: " + product);
        }
    }
}
